...
// BITORO Arbitrum mainnet contracts
export const BitoroLiquidityPoolAddress = "0xAF4D608C5D8C795f4Da096c8C58c5c0B707eB8D7"
export const BitoroOrderBookAddress = "0xa19fD5aB6C8DCffa2A295F78a5Bb4aC543AAF5e3"
export const ProxyAdminAddress = "0xEd594Fee4Ab06cB8BFCB52293A74aD9db3e4C778"
export async function getArbOneBlockNumber() {
  const provider = new ethers.providers.JsonRpcProvider('https://arb1.arbitrum.io/rpc')
  const blockNumber = await provider.getBlockNumber();
  console.log('currentarbtrum block number;;;', blockNumber)
  return blockNumber
}
